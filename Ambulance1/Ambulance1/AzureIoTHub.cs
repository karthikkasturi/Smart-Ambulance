...
class AzureIoTHub
{
    ...
    //
    const string deviceConnectionString = "HostName=SmartAmbulanceHub.azure-devices.net;DeviceId=Ambulance-1;SharedAccessKey=agEj/6v3htOeSsjvG0FRWD09zuF/LhX88EQ1CrMyZxY=";
                                                                                                                        

    //
    // To monitor messages sent to device "kraaa" use iothub-explorer as follows:
    //    iothub-explorer monitor-events --login HostName=kmithub.azure-devices.net;SharedAccessKeyName=service;SharedAccessKey=uo0KlGECkFO24nWHyAwXejgNhIDcVtXXtyx6nfvWZzM= "IotPlants"
    //
    ...
    public static async Task SendDeviceToCloudMessageAsync(string str)
    {
        CreateClient();
#if WINDOWS_UWP
       // var str = "{\"deviceId\":\"IotPlants\",\"messageId\":1,\"text\":\"Hello, Cloud from a UWP C# app!\"}";
#else
        var str = "{\"deviceId\":\"IotPlants\",\"messageId\":1,\"text\":\"Hello, Cloud from a C# app!\"}";
#endif
