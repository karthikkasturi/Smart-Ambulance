...
class AzureIoTHub
{
    ...
    //
    const string deviceConnectionString = "HostName=SmartAmbulanceIoT.azure-devices.net;DeviceId=ambulance1;SharedAccessKey=0BoPDAP1diP8vjPb1yMPgYTvIM5Ho5yhFrtyPTSlXag=";
